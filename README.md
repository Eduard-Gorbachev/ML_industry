...
Наилучшим образом справилась модель градиентного бустинга `LGBMRegressor`. С помощью `OptunaSearchCV` мы получили модель LGBMRegressor со следующими гиперпараметрами: `'max_depth': 46, 'n_estimators': 205, 'learning_rate': 0.020850523701962827`. Метрика `MAE` на кросс-валидации модели составила 6.11.
